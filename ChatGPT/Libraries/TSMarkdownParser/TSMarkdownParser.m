...
- (instancetype)init {
    ...
    if(self) {
        ...
        _h1Font = [UIFont boldSystemFontOfSize:16];
        _h2Font = [UIFont boldSystemFontOfSize:15];
        _h3Font = [UIFont boldSystemFontOfSize:14];
        _h4Font = [UIFont boldSystemFontOfSize:14];
        _h5Font = [UIFont boldSystemFontOfSize:14];
        _h6Font = [UIFont boldSystemFontOfSize:14];
        _linkColor = [UIColor colorWithRed:74/255.0 green:125/255.0 blue:112/255.0 alpha:1];
        _linkUnderlineStyle = @(NSUnderlineStyleSingle);
        _monospaceFont = [UIFont fontWithName:@"Menlo" size:14];
        _monospaceTextColor = [UIColor colorWithRed:197/255.0 green:135/255.0 blue:10/255.0 alpha:1];
    }
    return self;
}
...
+ (instancetype)standardParser {
    ...
    [defaultParser addParagraphParsingWithFormattingBlock:^(NSMutableAttributedString *attributedString, NSRange range) {
        ...
        [attributedString addAttribute:NSForegroundColorAttributeName
                                 value:[UIColor colorWithRed:85/255.0 green:85/255.0 blue:85/255.0 alpha:1]
                                 range:range];
    }];
